...
// under the License.
////////////////////////////////////////////////////////////////////////////// 
#ifndef BRCM_SC_BITREF_CLASSES_H_
#define BRCM_SC_BITREF_CLASSES_H_
...
namespace sc_ft {
	...
	template <int I_> class sc_int_bitref {
	public:
		bool val;
		int index;
		sc_int<I_> *val_ptr;
		// tbd
		template <int W> sc_int_bitref& operator = (const sc_uint<W>& a) {
			val = a.to_int();  return *this;}
		template <int W> sc_int_bitref& operator = (const sc_int<W>& a) {
			val = a.to_int();  return *this;}

		sc_int_bitref& operator = (const sc_int_bitref& a) {
			if (a.val) *val_ptr |= (a.val << index);
			else	   *val_ptr &= ~(a.val << index);
			return *this;
		}
		sc_int_bitref& operator = (const int& a) {
			val = a;
			return *this;
		}
